...
/*
$('.offset-combo-wrap').each(function(){
	
	if ($(this).hasClass("mPS2id-target")) {
	
		var video_screen = $(this).find('video');
	...
	if($("#loader").length) {
        ...
        $(document).ready(function() {
            $("form").submit(function(e){
                ...
                e.preventDefault(e);
                $.ajax({
                    url: '/wp-content/themes/the-salt-lounge/OpportunityAPI.php',
                    type: 'POST',
                    data: formdata,
...
if($('body').hasClass('page-template-pos')) {

	$('canvas').fadeIn('slow').delay(500);
...
// 	Masthead
	...
	var navHeight = document.getElementById('site-navigation').clientHeight;      
	var canvas = document.querySelector("canvas");
	var mastHead = document.getElementById('masthead').clientHeight;
	var logoHeight = document.getElementById('logo-wrap').clientHeight;
	var c = canvas.getContext("2d");
	
	canvas.style.marginTop = navHeight + "px";
	document.getElementById("nav-spacer").style.marginTop = navHeight + "px";
...
if($('body').hasClass('home')) {
	$('.single_slide').imagesLoaded( function() {	
		$('.review-slider').slick({
...
attribution: 'Tiles courtesy of <a href="http://openstreetmap.se/" target="_blank">OpenStreetMap Sweden</a> &mdash; Map data &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
     ...
     var marker = L.marker([40.3409902,-75.9865528]).addTo(map);
